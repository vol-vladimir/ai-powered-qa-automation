...
test.describe("Didaxis Studio — dashboard display and navigation (DS-119)", () => {
  ...
  test("TC-006: Re-entering Dashboard after Programs navigation still shows all blocks", async ({
    page,
  }) => {
    const dashboard = new DashboardPage(page);
    const programs = new ProgramsPage(page);
